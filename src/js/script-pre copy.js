...
function createNavigation() {
  ...
  <div class="navigation">
    <div class="logo" aria-label="Home Page" tabindex="9">
      <a href="../index.html"> 
        <img
          class="logo__img"
          src=${src}
    ...
    <input type="checkbox" 
    role="button"
    class="navigation__checkbox" id="navi-toggle"/>

    <label for="navi-toggle"     
    class="navigation__button" aria-label="Navigation Button" tabindex="1">
      <span class="navigation__icon">&nbsp;</span>
    </label>

    <div class="navigation__background">&nbsp;</div>

    <nav class="navigation__nav" aria-label="Navigation Menu" aria-expanded="true">
...
// MAIN MENU CHECK SELECTION FROM HTML MENU TRIANGLE ONCLICK EVENT
...
document
  ...
  .addEventListener('keydown', menuSelectorHandler);
